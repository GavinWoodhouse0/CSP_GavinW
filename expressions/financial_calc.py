...
#Calcutlate percent of rent (rent/income) (variable)

#Calcutlate percent of utilities (utilities/income) (variable)

#Calcutlate percent of groceries (groceries/income) (variable)

#Calcutlate percent of transportation (transportation/income) (variable)

#Calcutlate percent of spending money (spending money/income) (variable)
